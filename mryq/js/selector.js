;(function($){
    ...
    $('body').append('<style>'+
                ...
                '.sel-box .btn{background:#f2f2f2;overflow:hidden;}'+
                '.sel-box .btn1{overflow:hidden;float:left;padding:11px 12px;color:#666}'+
                '.sel-box .ok{float:right;color:#55aaff}'+
                '.sel-box .name{color:#333;text-align:center;line-height:22px;font-size:14px;padding:11px 0;}'+
                '.sel-con{background:white;}'+
                '.sel-con .border{height:34px;border:solid 1px #ddd;border-width:1px 0;position:fixed;bottom:72px;left:0;right:0;pointer-events:none;background-color:rgba(0,0,0,0.01)}'+
